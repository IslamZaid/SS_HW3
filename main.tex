...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{1\textwidth}
        \includegraphics[width=\textwidth]{Matlab/images/WhitePaint_silicate/temp_time.png}
        \caption{}
        \label{fig:temptime}
    \end{subfigure}
    \begin{subfigure}[b]{1\textwidth}
        \includegraphics[width=\textwidth]{Matlab/images/WhitePaint_silicate/QQQ_time.png}
        \caption{}
        \label{fig:temptime}
    \end{subfigure}
    \begin{subfigure}[b]{1\textwidth}
        \includegraphics[width=\textwidth]{Matlab/images/WhitePaint_silicate/Q_time.png}
        \caption{}
        \label{fig:temptime}
    \end{subfigure}
